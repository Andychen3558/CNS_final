...
def authenticate(username):
	...
	good , next_question_words, next_question_urls = userAPIs.try_to_login_v2(user.username, user.password, sessionid)
	# print(next_question_words)
	if request.method == 'POST':
		...
		if not good:
			...
			return render_template('authenticate.html', next_question=next_question_words)
